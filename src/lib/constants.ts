...
export const FOOTER_HEADER_ENDPOINT = `${process.env.NEXT_PUBLIC_WORDPRESS_SITE_URL}/wp-json/rae/v1/header-footer?header_location_id=hcms-menu-header&footer_location_id=hcms-menu-footer`;
export const FRONTEND_SITE_URL = process.env.NEXT_PUBLIC_SITE_URL;
